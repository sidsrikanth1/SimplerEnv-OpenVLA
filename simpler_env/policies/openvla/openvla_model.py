...
class OpenVLAInference:
    def __init__(
        self,
        saved_model_path: str = "fhliang/google_robot_base_20k",
        unnorm_key: Optional[str] = "simpler_env_success_dataset",
        ...
        self._ckpt_path = saved_model_path # snapshot_download(saved_model_path)
